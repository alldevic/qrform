                ...
                v-card(class="elevation-2 rounded-card" tile)
                    v-col(class="pa-0")
                        v-list-item(three-line class="flex-column px-6")
                            ...
                            v-list-item-content
                                v-list-item-title(class="headline my-6 text-center font-weight-light")
                                    | Страница контейнера №{{ currentChecklist.container_id }}
                                v-list-item-subtitle(class="font-weight-light")
                                    | Контейнек расположен по адресу {{ currentChecklist.platform_name }}
                                v-list-item-subtitle(class="font-weight-light")
                                    | Последний раз контейнер вывозился 03 часа назад
                                v-list-item-subtitle(class="font-weight-light")
                                    | Контейнер принадлежит {{ currentChecklist.container_owner }}
                        ...
                        v-card-text(class="px-6 pb-0")
                            v-form
                                header(
                                    ...
                                    | Помогите нам и ответьте на несколько вопросов:
                                div(
                                    ...
                                    v-flex(class="mx-auto" style="width: 70%")
                                        ValidationProvider(
                                            ...
                                            v-radio-group(
                                                ...
                                                header(class="mr-4") {{ question.text }}
                                                v-radio(
